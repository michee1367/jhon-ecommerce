        ...
        <header class="navbar navbar-expand-md sticky-top d-print-none">
                <div class="container-fluid">
                    ...
                    <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                        <a href="/">
                            <!--img src="~/assets/img/logo.png" width="110" height="32" alt="Tabler"
                    ...
                    <div class="navbar-nav flex-row order-md-last">
                        ...
                        <div class="d-none d-md-flex">
                            ...
                            <div class="nav-item dropdown d-none d-md-flex me-3" v-if="false">
        ...
        <header class="navbar-expand-md">
            <div class="collapse navbar-collapse" id="navbar-menu">
                <div class="navbar">
                    <div class="container-fluid">
                        <ul class="navbar-nav">
                            <li class="nav-item" :class="{'active': $route.name?.startsWith('index')}">
                            ...
                            <li class="nav-item" :class="{'active': $route.name?.startsWith('users')}">
                            ...
                            <li class="nav-item" :class="{'active': $route.name?.startsWith('users')}">
                                <NuxtLink class="nav-link" :to="'/'+$route.params?.org + '/modules'">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
                                        <svg 
                                            xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" 
                                            stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="my-2 my-md-0 flex-grow-1 flex-md-grow-0 order-first order-md-last">
                            <form action="./" method="get" autocomplete="off" novalidate>
                                <div class="input-icon">
                                    <span class="input-icon-addon" v-if="false">
                                        ...
                                        <select class="form-select" @change.prevent="goto($event.target.value)">
                                            <option 
