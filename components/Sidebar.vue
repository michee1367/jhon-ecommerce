        ...
        <div class="container-fluid">
		   ...
		   data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                ...
                <div class="d-none d-xl-block ps-2" v-if="user">
                  <div>{{ user?.names }}</div>
                  <div class="mt-1 small text-secondary"></div>
                </div>
              </a>
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                <a href="#" class="dropdown-item">{{ user?.names }}</a>
                <a href="./profile.html" class="dropdown-item" v-if="false">Profile</a>
                <a href="#" class="dropdown-item" v-if="false">Feedback</a>
                <div class="dropdown-divider"></div>
                <a href="./settings.html" class="dropdown-item" v-if="false">Settings</a>
          ...
          <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
              <li class="nav-item">
                <NuxtLink class="nav-link" :to="`/${org}`" >
              ...
              <li class="nav-item" v-for="(resource, index) in ressources" :key="index">
                <a class="nav-link" href="#" @click.prevent="goto(resource.name, mod?.module_id)"  >
...
import * as userManager from '@/tools/user';
  ...
  const goto = (tablename, module_id) => {
    
    router.push(`/${org}/modules/${module_id}/${tablename}`)
  }
