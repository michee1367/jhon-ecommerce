        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
              ...
              <li class="nav-item dropdown" v-for="(mod, index) in ressources" :key="index">
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      ...
                      <a 
                        class="dropdown-item" 
                        href="#" @click.prevent="goto(resource.name, mod?.module_id)" 
                        v-for="(resource, i) in mod?.ressources" :key="i"
                        >
                        {{ resource?.normalName }}
                      </a>
                    </div>
