                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="col-md-6 col-xl-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="password" class="form-control" name="example-required-input" placeholder="Required..." v-model="payload.password">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label required">Confirmation mot de passe</label>
                                                <input type="password" class="form-control" name="example-required-input" placeholder="Required..." v-model="payload.passwordConfirm">
                                            </div>
                                        </div>
                                    </div>
                                    </div>
